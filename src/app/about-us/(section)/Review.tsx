...
const Reviews = () => {
  ...
  return (
    <section className="relative flex h-full w-full justify-center bg-[#194129] pb-10">
      <div
      ...
      <div className="flex h-full w-full flex-col items-center justify-center gap-4 rounded-t-full py-12 md:py-44 md:pt-24">
        <div className="flex h-full w-full flex-col items-center justify-center gap-2 lg:gap-4">
          <div className="flex flex-col items-center justify-center gap-2">
            <motion.h6
              ...
              whileInView="visible"
              viewport={{ amount: 0.5 }}
              className="pb-6 text-center font-marcellus text-5xl font-[400] uppercase text-[#fff] md:text-6xl"
            >
              Hear Our Guests
            </motion.h6>
          </div>
        ...
        <div className="flex w-full items-center justify-center">
          {reviews && (
            ...
            //         <CarouselItem
            //           key={index}
            //           className="flex w-full basis-full flex-col items-center justify-center gap-6 rounded-none border border-[#fff] bg-transparent py-6 md:basis-1/3 md:py-12"
            //         >
            ...
            <Carousel className="w-full px-2 md:px-2">
              <CarouselContent className="flex w-full gap-4">
                {reviews
                  ...
                  .map((review, index) => (
                    <CarouselItem
                      key={index}
                      className="ml-1 flex basis-full flex-col items-center justify-center gap-6 border border-[#fff] bg-transparent py-6 md:basis-1/3 md:py-12"
                    >
                      <div className="flex flex-col gap-3 bg-transparent px-6 pb-6">
                        <div className="flex w-full justify-center">
                          {Array.from({ length: review.rating }).map(
