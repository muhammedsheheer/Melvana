    ...
    return (
        ...
        >
            <div className="absolute w-full h-full left-0 top-0 hidden md:flex justify-center items-start">
                <div className="w-full h-full ml-[108px] mr-[108px] xl:border-x-[0.25px] xl:border-x-primary z-30"></div>
            </div>
            {/* <div className="lines">
                ...
                <div className="z-30 flex flex-col md:flex-row gap-5 lg:gap-9 h-full w-full max-w-[1300px] items-center lg:items-center justify-start">
                    <div className="w-full md:w-1/2 flex flex-col md:flex-row gap-4 justify-center items-center">
                        <Image
                            ...
                            height={590}
                            alt="tips"
                            className="md:max-w-[300px] tips-container h-96 lg:h-auto object-contain"
                            style={{
                                transform: "scale(1.3)",
                                opacity: 0
                            }}
                        ...
                        <Image
                            ...
                            height={590}
                            alt="tips"
                            className="md:mt-[100px] md:max-w-[300px] tips-container h-96  lg:h-auto object-contain"
                            style={{
                                transform: "scale(1.3)",
                                opacity: 0
                            }}
                    ...
                    <div className="w-full md:w-1/2 flex flex-col gap-7 justify-center items-center">
                        ...
                        <p className="styled_section_head uppercase text-primary text-center mt-[-28px] flex gap-3 justify-center items-center">
