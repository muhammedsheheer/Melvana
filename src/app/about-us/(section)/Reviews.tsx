    ...
    <section className="relative flex h-full w-full justify-center bg-transparent">
      <div className="flex h-full w-full max-w-[1300px] flex-col items-start justify-center gap-4 py-12 md:pb-44">
        <div className="flex h-full w-full flex-col items-start justify-center gap-2 lg:gap-4">
          <h3 className="font-playfair italic text-3xl w-full text-center text-[#C2C2C2]">Testimonials</h3>
          <h1 className="w-full text-center text-[#C2C2C2] font-inter font-light text-5xl uppercase">
